...
**插入种子数据**
```text
INSERT INTO log_par(user_id,create_time) SELECT round(100000000*random()) , generate_series('2019-01-01'::timestamptz,'2020-04-01'::timestamptz,'1 minute');
```
...
--------+----------------+-------+----------+---------+-------------
 ...
 public | log_par_201905 | table | postgres | 7512 kB |
 public | log_par_201910 | table | postgres | 9552 kB |
 public | log_par_202005 | table | postgres | 11 MB   |
```
